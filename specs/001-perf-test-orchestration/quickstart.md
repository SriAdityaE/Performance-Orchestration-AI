...
- Confirm external backup files are written under `L:\testlogs\<run_id>\<date_bucket>\<YYYYMMDD>_<test_name>_round<index>_<HHMMSS>\` using the round-based naming convention.
